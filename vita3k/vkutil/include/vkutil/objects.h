...
struct Image {
    ...
    void init_image(vk::ImageUsageFlags usage, vk::ComponentMapping mapping = default_comp_mapping, const vk::ImageCreateFlags image_create_flags = vk::ImageCreateFlags(), const void *pNext = nullptr, vk::Format stencil);
    // called by ~Image
    void destroy();
